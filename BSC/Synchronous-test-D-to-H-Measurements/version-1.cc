...
int main(int argc, char *argv[]) {
    ...
    // ── Initial H→D transfer (populate device buffer before D→H timing) ──────
    ...
    // After D→H the data is already in h_A — allocate a fresh reference buffer
    // and compare a sample against the known init value (1.0)
