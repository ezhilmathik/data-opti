...
int main(int argc, char *argv[]) {
    ...
    checkCuda(cudaSetDevice(0), "cudaSetDevice 0");
    checkCuda(cudaMemcpy(d_A, h_A, bytes, cudaMemcpyHostToDevice), "warmup d_A");
    checkCuda(cudaSetDevice(1), "cudaSetDevice 1");
    checkCuda(cudaMemcpy(d_B, h_B, bytes, cudaMemcpyHostToDevice), "warmup d_B");
    checkCuda(cudaSetDevice(2), "cudaSetDevice 2");
    checkCuda(cudaMemcpy(d_C, h_C, bytes, cudaMemcpyHostToDevice), "warmup d_C");
    checkCuda(cudaSetDevice(3), "cudaSetDevice 3");
    checkCuda(cudaMemcpy(d_D, h_D, bytes, cudaMemcpyHostToDevice), "warmup d_D");
    ...
    #pragma omp parallel sections
    {
        ...
        {
            checkCuda(cudaSetDevice(1), "cudaSetDevice 1");
            checkCuda(cudaMemcpy(d_B, h_B, bytes, cudaMemcpyHostToDevice), "timed cudaMemcpy d_B");
        }
        #pragma omp section
        {
            checkCuda(cudaSetDevice(2), "cudaSetDevice 2");
            checkCuda(cudaMemcpy(d_C, h_C, bytes, cudaMemcpyHostToDevice), "timed cudaMemcpy d_C");
        }
        #pragma omp section
        {
            checkCuda(cudaSetDevice(3), "cudaSetDevice 3");
            checkCuda(cudaMemcpy(d_D, h_D, bytes, cudaMemcpyHostToDevice), "timed cudaMemcpy d_D");
        }
    }
    ...
    checkCuda(cudaSetDevice(0), "cudaSetDevice 0");
    checkCuda(cudaMemcpy(h_verifyA, d_A, sample_bytes, cudaMemcpyDeviceToHost), "verify d_A");
    checkCuda(cudaSetDevice(1), "cudaSetDevice 1");
    checkCuda(cudaMemcpy(h_verifyB, d_B, sample_bytes, cudaMemcpyDeviceToHost), "verify d_B");
    checkCuda(cudaSetDevice(2), "cudaSetDevice 2");
    checkCuda(cudaMemcpy(h_verifyC, d_C, sample_bytes, cudaMemcpyDeviceToHost), "verify d_C");
    checkCuda(cudaSetDevice(3), "cudaSetDevice 3");
    checkCuda(cudaMemcpy(h_verifyD, d_D, sample_bytes, cudaMemcpyDeviceToHost), "verify d_D");
