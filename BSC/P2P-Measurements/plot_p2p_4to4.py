#!/usr/bin/env python3
"""
plot_p2p_4to4.py  —  Bandwidth vs N for version v4_4  (4-to-4 GPU topology)
─────────────────────────────────────────────────────────────────────────────
Usage:
    python3 plot_p2p_4to4.py
...
def load_csv(path, version):
    """Returns { (framework, N): [bandwidth, ...] } for the given version."""
