#!/usr/bin/env python3
"""
plot_htod.py  —  Bandwidth vs N for versions v1, v2, v4  (H-to-D transfer)
─────────────────────────────────────────────────────────────────────────────
Usage:
...
NOTE: handles CSV rows that have an extra empty column after N, e.g.:
    omp_off,v1,940000000,,0.611239,12.302881,ok   (7 fields)
    omp_off,v1,4960000000,3.246444,12.222604,ok   (6 fields)
"""
...
def main():
    ...
    out_path = os.path.join(OUTPUT_DIR, "htod_bandwidth.pdf")
